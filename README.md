...
|27      |Remove Element                                         |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|28      |Find the Index of the First Occurrence in a String     |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|35      |Search Insert Position                                 |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|58      |Length of Last Word                                    |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|69      |Sqrt(x)                                                |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
...
|349     |Intersection of Two Arrays                             |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|412     |Fizz Buzz                                              |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|448     |Find All Numbers Disappeared in an Array               |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|463     |Island Perimeter                                       |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|495     |Teemo Attacking                                        |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
...
|709     |To Lower Case                                          |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|771     |Jewels and Stones                                      |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|867     |Transpose Matrix                                       |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
...
|1920    |Build Array from Permutation                           |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2000    |Reverse Prefix of Word                                 |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2011    |Final Value of Variable After Performing Operations    |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2073    |Time Needed to Buy Tickets                             |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2108    |Find First Palindromic String in the Array             |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2114    |Maximum Number of Words Found in Sentences             |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2215    |Find the Difference of Two Arrays                      |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2235    |Add Two Integers                                       |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2293    |Min Max Game                                           |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2413    |Smallest Even Multiple                                 |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2441    |Largest Positive Integer That Exists With Its Negative |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2485    |Find the Pivot Integer                                 |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
...
|2667    |Create Hello World Function                            |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
...
|2951    |Find the Peaks                                         |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|2974    |Minimum Number Game                                    |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|3000    |Maximum Area of Longest Diagonal Rectangle             |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
|3005    |Count Elements With Maximum Frequency                  |${\textsf{\color{Lightgreen}Easy}}$  |Java and JavaScript  |
...
|7     |Reverse Integer                                 |${\textsf{\color{Dandelion}Medium}}$  |[Java](https://github.com/LucasGPrudente/leetcode-problems/blob/main/algorithm/0007-reverse-integer/Solution.java) and [JavaScript](https://github.com/LucasGPrudente/leetcode-problems/blob/main/script/0007-reverse-integer/Solution.js)  |
|38    |Count and Say                                   |${\textsf{\color{Dandelion}Medium}}$  |[Java](https://github.com/LucasGPrudente/leetcode-problems/blob/main/algorithm/0038-count-and-say/Solution.java) and [JavaScript](https://github.com/LucasGPrudente/leetcode-problems/blob/main/script/0038-count-and-say/Solution.js)  |
|50    |Pow(x, n)                                       |${\textsf{\color{Dandelion}Medium}}$  |[Java](https://github.com/LucasGPrudente/leetcode-problems/blob/main/algorithm/0050-powx-n/Solution.java) and [JavaScript](https://github.com/LucasGPrudente/leetcode-problems/blob/main/script/0050-powx-n/Solution.js)  |
|74    |Search a 2D Matrix                              |${\textsf{\color{Dandelion}Medium}}$  |[Java](https://github.com/LucasGPrudente/leetcode-problems/blob/main/algorithm/0074-search-a-2d-matrix/Solution.java) and [JavaScript](https://github.com/LucasGPrudente/leetcode-problems/blob/main/script/0074-search-a-2d-matrix/Solution.js)  |
|151   |Reverse Words in a String                       |${\textsf{\color{Dandelion}Medium}}$  |[Java](https://github.com/LucasGPrudente/leetcode-problems/blob/main/algorithm/0151-reverse-words-in-a-string/Solution.java) and [JavaScript](https://github.com/LucasGPrudente/leetcode-problems/blob/main/script/0151-reverse-words-in-a-string/Solution.js)  |
|442   |Find All Duplicates in an Array                 |${\textsf{\color{Dandelion}Medium}}$  |[Java](https://github.com/LucasGPrudente/leetcode-problems/blob/main/algorithm/0442-find-all-duplicates-in-an-array/Solution.java) and [JavaScript](https://github.com/LucasGPrudente/leetcode-problems/blob/main/script/0442-find-all-duplicates-in-an-array/Solution.js)  |
|665   |Non-decreasing Array                            |${\textsf{\color{Dandelion}Medium}}$  |Java and JavaScript  |
|841   |Keys and Rooms                                  |${\textsf{\color{Dandelion}Medium}}$  |Java and JavaScript  |
|2396  |Strictly Palindromic Number                     |${\textsf{\color{Dandelion}Medium}}$  |Java and JavaScript  |
